...
export const FAMILY_FIELD_PRIORITY: Record<string, string[]> = {
  ...
  hayabusa: ["Timestamp", "RuleTitle", "Level", "Computer", "Channel", "EventID", "Details"],
  chainsaw: ["timestamp", "detections", "path", "Event ID", "Computer", "Event Data"],
  sigma: ["timestamp", "detections", "path", "Event ID", "Computer", "Event Data"],
  suzaku: ["Timestamp", "RuleTitle", "Level", "Computer", "Channel", "EventID", "Details"],
  evtxecmd: ["TimeCreated", "EventId", "Provider", "Channel", "Computer", "MapDescription", "UserName", "Payload", "ExecutableInfo", "RemoteHost"],
